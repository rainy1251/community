...
//        options.mNosTokenSceneConfig = createNosTokenScene();
    ...
    private static StatusBarNotificationConfig loadStatusBarNotificationConfig() {
        ...
        config.notificationSmallIconId = R.drawable.icon_audio_close;
        config.notificationColor = DemoCache.getContext().getResources().getColor(R.color.coffeeColor);
        // 通知铃声的uri字符串
        config.notificationSound = "android.resource://com.zz.imdemo/raw/msg";

...
import com.service.community.hxim.InviteMessage.InviteMessageStatus;
...
import com.service.community.db.DemoDBManager;
import com.service.community.db.InviteMessgeDao;
import com.service.community.db.UserDao;
        ...
        messageListener = new EMMessageListener() {
            ...
            public void onMessageReceived(List<EMMessage> messages) {
                for (EMMessage message : messages) {
                    ...
                    String userName = message.getStringAttribute("nickname", "nick");
                    String userPic = message.getStringAttribute("userPic", "https://yanxuan.nosdn.127.net/80841d741d7fa3073e0ae27bf487339f.jpg?imageView&quality=90&thumbnail=64x64");

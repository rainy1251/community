...
//        inputMenu.registerExtendMenuItem(R.string.attach_file, R.drawable.em_chat_file_selector, ITEM_FILE, extendMenuItemClickListener);
        if (chatType == Constant.CHATTYPE_SINGLE) {
            inputMenu.registerExtendMenuItem(R.string.attach_voice_call, R.drawable.ease_chat_voice_call_selector, ITEM_VOICE_CALL, extendMenuItemClickListener);
            inputMenu.registerExtendMenuItem(R.string.attach_video_call, R.drawable.ease_chat_video_call_selector, ITEM_VIDEO_CALL, extendMenuItemClickListener);
        }
...
//        // 通过扩展属性，将userPic和userName发送出去。
        String userPic = SPUtils.getString("logoUrl");

...
public class Lunar {
    ...
    final static String chineseNumber[] = {"正", "二", "三", "四", "五", "六", "七", "八", "九", "十", "十一", "腊月"};
    final static String chineseNum[] = {"一", "二", "三", "四", "五", "六", "七", "八", "九", "十", "十一", "十二"};
...
//用offset减去每农历年的天数
        ...
        year = iYear;
        yearCyl = iYear - 1864;
        leapMonth = leapMonth(iYear); //闰哪个月,one-12
        leap = false;
...
//解除闰月
    ...
    public static String getChinaDayString(int day) {
        ...
        if (day == 10)
            ...
            return chineseTen[day / 10] + chineseNum[n];
    }
